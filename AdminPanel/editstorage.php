...
?>
    ...
    <script>
        function redirectToShowCPU() {
            setTimeout(function() {
                window.location.href = "showstorage.php";
            }, 500);
        }
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php endif; ?>
                                <h4 class="card-title">Edit Storage</h4>
                                <?php 
                                $fetch = "SELECT * FROM storage WHERE s_id = $c_id";
                                ...
                                <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cpu" placeholder="CPU Name" required value="<?php echo $rows['s_name']?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="core_count">Capacity</label>
                                        <input type="text" class="form-control" name="core_count" placeholder="Core Count" required value="<?php echo $rows['capacity']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="threads">Type</label>
                                        <input type="text" class="form-control" name="threads" placeholder="Threads" required value="<?php echo $rows['type']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="c_speed">Cache</label>
                                        <input type="text" class="form-control" name="c_speed" placeholder="Clock Speed" required value="<?php echo $rows['cache']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="oc_speed">Form Factor</label>
                                        <input type="text" class="form-control" name="oc_speed" placeholder="Max OverClock Speed" required value="<?php echo $rows['formfactor']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="tdp">Interface</label>
                                        <input type="text" class="form-control" name="tdp" placeholder="Thermal Design Power" required value="<?php echo $rows['interface']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="price">Price</label>
                                        <input type="number" class="form-control" name="price" placeholder="CPU Price" required value="<?php echo $rows['s_price']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="cpu_img">Sotrage Image</label>
