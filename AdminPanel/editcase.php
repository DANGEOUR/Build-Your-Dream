...
?>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE `pccase` SET `case_name`='$g_name',`manufacture`='$manufacture',`type`='$chipset',`color`='$memory',`sidepanel`='$cl_speed',`externalvolume`='$lenght',`case_price`='$price',`img`='$imagename' WHERE `case_id` = $cooler_id";
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php 
                                $fetch = "SELECT * FROM pccase WHERE case_id = $cooler_id";
                                ...
                                <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cooler" placeholder="Cooler Name" required value="<?php echo $rows['case_name']?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="threads">Color</label>
                                        <input type="text" class="form-control" name="noiselvl" placeholder="Noise Level" required value="<?php echo $rows['color']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="c_speed">Side Panel</label>
                                        <input type="text" class="form-control" name="color" placeholder="Color" required value="<?php echo $rows['sidepanel']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="oc_speed">External Volume</label>
                                        <input type="text" class="form-control" name="size" placeholder="Radiator Size" required value="<?php echo $rows['externalvolume']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="price">Price</label>
                                        <input type="number" class="form-control" name="price" placeholder="CPU Price" required value="<?php echo $rows['case_price']?>">
                                    </div>
                                    <div class="form-group">
