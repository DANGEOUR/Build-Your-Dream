...
?>
  <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">All PC Case</li>
      </ol>
    </nav>
    <br><br><br>
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <h4 class="card-title mb-0">All PC Case</h4>
            </div>
            <p>Following are the all PC Case which are on your website</p>
              ...
              <table class="table table-striped table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['type']?>RPM</td>
                    <td><?php echo $row['color']?>dB</td>
                    <td><?php echo $row['sidepanel']?></td>
                    <td><?php echo $row['externalvolume']?>mm</td>
                    <td><?php echo $row['case_price']?>$</td>

                    <td><a href="editcase.php?id=<?php echo $row['case_id']?>">Edit</a>/<a href="showcase.php?id=<?php echo $row['case_id']?>">Delete</a></td>
                  </tr>
                  <?php }?>
                </tbody>
              </table>
