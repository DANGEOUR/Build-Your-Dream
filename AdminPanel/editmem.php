                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php endif; ?>
                                <h4 class="card-title">Edit Memory (RAM)</h4>
                                <?php 
                                $fetch = "SELECT * FROM memory WHERE m_id = $c_id";
                                ...
                                <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cpu" placeholder="CPU Name" required value="<?php echo $rows['ram_name']?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="core_count">Speed</label>
                                        <input type="text" class="form-control" name="core_count" placeholder="Core Count" required value="<?php echo $rows['speed']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="threads">Modules</label>
                                        <input type="text" class="form-control" name="threads" placeholder="Threads" required value="<?php echo $rows['modules']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="c_speed">Color</label>
                                        <input type="text" class="form-control" name="c_speed" placeholder="Clock Speed" required value="<?php echo $rows['color']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="oc_speed">First Word Latency	</label>
                                        <input type="number" class="form-control" name="oc_speed" placeholder="Max OverClock Speed" required value="<?php echo $rows['firstwordlatency']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="tdp">CAS Latency</label>
                                        <input type="text" class="form-control" name="tdp" placeholder="Thermal Design Power" required value="<?php echo $rows['CASlatency']?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="price">Price</label>
                                        <input type="number" class="form-control" name="price" placeholder="CPU Price" required value="<?php echo $rows['ram_price']?>">
                                    </div>
                                    <div class="form-group">
