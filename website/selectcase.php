        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $row['externalvolume']; ?></td>
                    <td>$<?php echo $row['case_price']; ?></td>
                    <td>
                        <a href="custombuild.php?case_id=<?php echo $row['case_id']; ?>&c_id=<?php echo $cpu_id; ?>&g_id=<?php echo $g_id; ?>&cooler_id=<?php echo $cooler_id; ?>&mb_id=<?php echo $mb_id; ?>&m_id=<?php echo $ram_id; ?>&psu_id=<?php echo $psu_id; ?>&s_id=<?php echo $storage_id; ?>" class="btn btn-border btn-with-icon btn-small ripple">
